...
public class ProcessMain { 
    ...
    public static final void main(String[] args) throws Exception {
        ...
        // 5. Start a exceptionhandlingprocess instance
        Map<String, Object> params = new HashMap<String, Object>();
	    params.put("name", null);
	    log.info("Process starting ...");
	    ksession.startProcess("com.hi.techpoints.process.exceptionhandlingprocess", params);     
    ...
    public static RuntimeManager createRuntimeEnvironment(KieBase kbase) {
		...
		properties.put("url", "jdbc:h2:tcp://localhost/~/jbpm-error");
