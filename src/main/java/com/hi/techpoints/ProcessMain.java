...
import com.hi.techpoints.handler.CustomWorkItemHandler;


/**
 * Creating a jBPM runtime for executing a `customworkitemprocess.bpmn2`.
 * 
...
public class ProcessMain { 
    ...
    public static final void main(String[] args) throws Exception {
        ...
        ksession.getWorkItemManager().registerWorkItemHandler("My WorkItem", new CustomWorkItemHandler());
        
        // 5. Start a embeddedsubprocess process instance with parameter	     
	    Map<String, Object> params = new HashMap<String, Object>();
	    params.put("param1", "Elavarasan");	
	    params.put("param2", "PK");
	    log.info("Process starting ...");
	    ksession.startProcess("com.hi.techpoints.process.customworkitemprocess", params);     
